  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Category" do
        expect {
          post :create, params: {admin_category: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved admin_category as @admin_category" do
        post :create, params: {admin_category: invalid_attributes}, session: valid_session
        expect(assigns(:admin_category)).to be_a_new(Admin::Category)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_category" do
        category = Admin::Category.create! valid_attributes
        put :update, params: {id: category.to_param, admin_category: new_attributes}, session: valid_session
        category.reload
      ...
      it "assigns the requested admin_category as @admin_category" do
        category = Admin::Category.create! valid_attributes
        put :update, params: {id: category.to_param, admin_category: valid_attributes}, session: valid_session
        expect(assigns(:admin_category)).to eq(category)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_category as @admin_category" do
        category = Admin::Category.create! valid_attributes
        put :update, params: {id: category.to_param, admin_category: invalid_attributes}, session: valid_session
        expect(assigns(:admin_category)).to eq(category)
      end
