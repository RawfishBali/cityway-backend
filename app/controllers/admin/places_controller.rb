class Admin::PlacesController < Admin::BaseController
  ...
  private
    ...
    def admin_place_params
      params.require(:place).permit(:name, :address, :description, :website,:place_type, :email, :facebook, :instagram, :twitter, :google_plus, :phone, :external_link, business_hours_attributes: [:id, :morning_open_time, :morning_close_time, :evening_open_time,
