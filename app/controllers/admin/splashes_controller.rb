class Admin::SplashesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_splash.save
        format.html { redirect_to admin_splashes_url, notice: 'Splash was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @admin_splash.update(admin_splash_params)
        format.html { redirect_to admin_splashes_url, notice: 'Splash was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_splashes_url, notice: 'Splash was successfully destroyed.' }
