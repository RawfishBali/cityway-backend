class Admin::DevicesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_device.save
        format.html { redirect_to session['previous_url'] || admin_devices_url(device_type: @admin_device.device_type), notice: 'Device was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @admin_device.update(admin_device_params)
        format.html { redirect_to session['previous_url'] || admin_devices_url(device_type: @admin_device.device_type), notice: 'Device was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to session['previous_url'] || admin_devices_url, notice: 'Device was successfully destroyed.' }
