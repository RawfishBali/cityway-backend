class Admin::PublicOfficesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_public_office.save
        format.html { redirect_to admin_public_offices_url, notice: 'Public office was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @admin_public_office.update(admin_public_office_params)
        format.html { redirect_to admin_public_offices_url, notice: 'Public office was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_public_offices_url, notice: 'Public office was successfully destroyed.' }
