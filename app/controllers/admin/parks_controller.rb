class Admin::ParksController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_park.save
        format.html { redirect_to admin_parks_path, notice: 'Park was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @admin_park.update(admin_park_params)
        format.html { redirect_to admin_parks_path, notice: 'Park was successfully updated.' }
