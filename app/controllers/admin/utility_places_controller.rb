  ...
  def create
    ...
    respond_to do |format|
      if @admin_utility_place.save
        format.html { redirect_to admin_utility_places_url(place_type: @admin_utility_place.place_type, is_public: @admin_utility_place.is_public), notice: 'Utility place was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @admin_utility_place.update(admin_utility_place_params)
        format.html { redirect_to admin_utility_places_url(place_type: @admin_utility_place.place_type, is_public: @admin_utility_place.is_public), notice: 'Utility place was successfully updated.' }
