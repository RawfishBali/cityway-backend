class Admin::WasteTypesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_waste_type.save
        format.html { redirect_to admin_waste_types_url, notice: 'Waste type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @admin_waste_type.update(admin_waste_type_params)
        format.html { redirect_to admin_waste_types_url, notice: 'Waste type was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_waste_types_url, notice: 'Waste type was successfully destroyed.' }
