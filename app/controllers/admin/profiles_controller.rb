class Admin::ProfilesController < Admin::BaseController
  ...
  private
    ...
    def admin_profile_params
      params.require(:profile).permit(:commonplace_id, :is_city_council_member, :name, :role, :address, :email, :fax, :phone, :website, :appointment_start, :appointment_end, :description, :politic_group_id, :photo, :is_major, days_open: [])
    end
end
