      ...
      module Entities
        ...
        class Profile < Grape::Entity
          ...
          expose :unavailable, documentation: {:type => "Boolean", :desc => "Profile Timetable Availability"} do |profile,options|
            profile.unavailable && profile.days_open && profile.appointment_start && profile.appointment_end
          end
        ...
        class Administration < Grape::Entity
          ...
          expose :vice_major do |commonplace, options|
        ...
        class Merchant < Grape::Entity
          ...
          expose :email,if: lambda { |object, options| options[:simple] == 'false'}, documentation: {:type => "string", :desc => "Merchant email"} do |merchant, options|
